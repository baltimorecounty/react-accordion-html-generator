				...
				<div className="row">
					<div className="col-md-12">
						<div className="form-group">
							<label htmlFor={`accordion-builder-title-${this.props.index}`}>{`Panel ${this.props.index} Title`}</label>
							<input id={`accordion-builder-title-${this.props.index}`} type="text" className="form-control" onChange={this.handleTitleChange} />
						</div>
						<div className="form-group">
							<label htmlFor={`accordion-builder-content-${this.props.index}`}>{`Panel ${this.props.index} Body`}</label>
